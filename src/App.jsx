...
const App = () => {
  ...
  const cakeData = [
    ...
    ...[
      ...
      "Cocadinha",
      "Limão cobertura mousse",
      "Maracujá cobert. mousse",
      "Pé de Moleque",
      "Prestígio",
      "Romeu e Julieta",
    ].map((name) => ({
              ...
              filteredCakes.map((cake) => (
                ...
                >
                  ...
                  <p className="text-sm text-stone-500 mb-4 flex-grow italic">
                    Gostoso abraço de vó em cada fatia.
                  </p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex justify-between items-center mt-3">
                      <div className="flex items-center gap-1 bg-stone-50 rounded-lg p-1 border border-stone-100">
                        ...
                        <button
                          onClick={() => addToCart({ id: item.id }, item.size)}
                          className="p-1 hover:bg-white rounded-md text-stone-500"
                        >
                          <Plus size={14} />
                        </button>
